...
\newcommand{\templatePortrait}{
	...
	\ifthenelse{\equal{\portraitstyle}{style12}}{%
		...
		\vfill
		\begin{center}
			{\bf \Huge \scshape{\textcolor{\portraittitlecolor}{\documenttitle}} \vspace{0.1cm} \\
			{\bf \Large \scshape{\textcolor{\portraittitlecolor}{\documentsubtitle}}} \vspace{0.3cm}} \\
			{\bf  \textcolor{\portraittitlecolor}{\documentsubject}}
		\end{center}
